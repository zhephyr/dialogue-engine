...
def create_example_scenario(
    ...
    world.add_fact(
        "estate_type", "Secluded country mansion", category="setting", is_public=True
    )
    world.add_fact(
        "gathering_purpose",
        "Evening social gathering hosted by Elias Morven",
        category="setting",
        is_public=True,
    )
    ...
    world.add_fact(
        "player_role",
        "Investigator from Scotland Yard",
        category="player",
        is_public=True,
    )
    world.add_fact(
        "player_authority",
        "Official police investigator",
        category="player",
        is_public=True,
    )
    world.add_fact(
        "player_arrival", "After Elias collapsed", category="player", is_public=True
    )
    ...
    world.add_fact(
        "delayed_action_poison",
        "Poison acts slowly and unpredictably",
        category="death",
        is_public=False,
        witnesses=["Nathan Cross"],
    )
    world.add_fact(
        "no_weapon_found", "No weapon at scene", category="death", is_public=True
    )
    world.add_fact(
        "no_physical_evidence",
        "No physical evidence at death scene",
        category="death",
        is_public=True,
    )
    ...
    world.add_fact(
        "missing_poison_vial",
        "A small empty glass vial was seen by Arthur in the Library garden earlier.",
        category="clue",
        is_public=False,
    ...
    world.add_event(
        ...
        details={"atmosphere": "social", "drinks_served": True, "all_present": True},
        sequence_order=0,
    )
    ...
    world.add_event(
        ...
        witnesses=["Arthur Bell", "Nathan Cross", "Helena Morven", "Lila Chen"],
        details={"response_time": "immediate", "all_converged": True},
        sequence_order=1,
        caused_by="death",
    )
    ...
    if verbose:
        ...
        print("\nKiller: Nathan Cross")
        print("Method: Poisoned wine earlier, death occurred later")
        print("Nathan has genuine alibi for moment of death (with Helena)")
        print("But his timeline about EARLIER events contains lies")
        print(f"\n{'=' * 70}")
